...
if qtdPesosFaixa1a10 > 0:
    ...
    print("A média faixa 1 a 10 anos: ",mediaPesosFaixa11a20)
...
if qtdPesosFaixa11a20 > 0:
    ...
    print("Não teve idade na faixa etária entre 11 a 20 anos!")
...
if qtdPesosFaixa21a30 > 0:
    ...
    print("Não teve idade na faixa etária entre 21 a 30 anos!")
...
if qtdPesosFaixa31Acima > 0:
    ...
    print("Não teve idade na faixa acima de 31 anos!")